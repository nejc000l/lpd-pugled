...
import file from '../public/ZNUAPK.pdf';
    ...
    return(
        ...
        <div className="container2">
            ...
            <div className="title big"><h1>Lovska <br /> Družina <br />Pugled </h1></div>
                    ...
                    <span>Starešina: Grčar Borja-Miki</span>
            ...
            <div className="container-right">
                    ...
                    <div className="box"><h1>{movie.title2}</h1></div>
                    <div className="box-data"><h3>{movie.text2}</h3></div>
